...
export const AddTechnicalSkill = makeAction<DND_ListEvents.ADD_TECHNICAL_SKILL, DND_Item>(
  DND_ListEvents.ADD_TECHNICAL_SKILL,
)

export const SetTechnicalSkills = makeAction<DND_ListEvents.SET_TECHNICAL_SKILLS, DND_Item[]>(
